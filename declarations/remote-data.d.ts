 ...
 * @protected
 */
export declare class State<T = unknown> {
    /**
 ...
 *
 */
export declare function remoteData<T = unknown>({ on }: ResourceAPI, url: string, options?: FetchOptions): State<T>;
/**
 ...
 *
 */
export declare function RemoteData<T = unknown>(url: string, options?: FetchOptions): State<T>;
/**
 * json-based remote data utility
 *
 *
 ...
 * ```
 */
export declare function RemoteData<T = unknown>(url: () => string): State<T>;
/**
 * json-based remote data utility
 *
 ...
 * ```
 */
export declare function RemoteData<T = unknown>(options: () => {
    url: string;
