 ...
 */
export type AsThunk<Args, Expanded = ThunkReturnFor<Args>> = Expanded extends NoArgs ? () => NoArgs | [] | EmptyObject | undefined | void : () => LoosenThunkReturn<Expanded>;
/**
 * @private utility type
 *
 ...
 * uppercase
 */
export type ThunkReturnFor<S> = S extends {
    named?: object;
    positional?: unknown[];
} ? {
 ...
 */
export type LoosenThunkReturn<Args> = Args extends {
    positional: unknown[];
    named: EmptyObject;
} ? {
 ...
 * ```
 */
export type Thunk<Args = ArgsWrapper> = (() => []) | (() => void) | (() => undefined) | (() => ThunkReturnFor<Args>['positional']) | (() => ThunkReturnFor<Args>['named']) | (() => Partial<ThunkReturnFor<Args>>) | (() => ThunkReturnFor<Args>);
export {};
