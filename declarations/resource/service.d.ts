 ...
 * ```
 */
export declare function service(resource: unknown): (_prototype: object, key: string, descriptor?: Stage1DecoratorDescriptor) => void;
 ...
 *
 */
export declare function serviceOverride(owner: Owner, { original, replacement }: RegisterOptions): void;
export {};
