 ...
 * ```
 */
export declare function addScript(url: string | (() => string), attributes?: undefined | (HTMLScriptElement & {})): void;
/**
 ...
 * ```
 */
export declare function addLink(url: string | (() => string), attributes?: undefined | (HTMLLinkElement & {})): void;
