 ...
 * @private
 */
export declare function proxyClass<ArgsList extends any[], Return, LocalTask extends TaskIsh<ArgsList, Return>, Instance extends TaskResource<ArgsList, Return, LocalTask> = TaskResource<ArgsList, Return, LocalTask>>(target: {
    value: Instance;
}): Instance;
 ...
 * @private
 */
export declare class TaskResource<Args extends any[], Return, LocalTask extends TaskIsh<Args, Return>> extends Resource<{
    positional: Args;
}> {
    [TASK]: LocalTask;
