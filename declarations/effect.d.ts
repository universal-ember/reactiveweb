 ...
 * ```
 */
export declare function effect<Args extends any[]>(fn: (...args: Args) => void | Promise<void>, ...args: Args): void;
/**
 ...
 */
export declare function renderEffect<Args extends any[]>(fn: (...args: Args) => void | Promise<void>, ...args: Args): void;
